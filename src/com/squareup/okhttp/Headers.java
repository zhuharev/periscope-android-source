...
public final class Headers
{
    public static final class Builder
    {
        ...
        public final Builder add(String s)
        {
            ...
            if (i == -1)
            {
                throw new IllegalArgumentException((new StringBuilder("Unexpected header: ")).append(s).toString());
            } else
            {
        ...
        final Builder addLenient(String s)
        {
            int i = s.indexOf(":", 1);
            if (i != -1)
            {
    ...
    Headers(Builder builder, _cls1 _pcls1)
    {
        this(builder);
    }
    ...
    public static Headers of(Map map)
    {
        ...
        String as[] = new String[map.size() << 1];
        int i = 0;
        for (map = map.entrySet().iterator(); map.hasNext();)
        {
            ...
            {
                throw new IllegalArgumentException((new StringBuilder("Unexpected header: ")).append(s).append(": ").append(((String) (obj))).toString());
            }
            as[i] = s;
            as[i + 1] = ((String) (obj));
            i += 2;

...
public static final class 
{
    ...
    public final namesAndValues add(String s)
    {
        int i = s.indexOf(":");
        if (i == -1)
        {
    ...
    final addLenient addLenient(String s)
    {
        int i = s.indexOf(":", 1);
        if (i != -1)
        {
    ...
    public final namesAndValues removeAll(String s)
    {
        int j;
    ...
    public final namesAndValues set(String s, String s1)
    {
        removeAll(s);
        add(s, s1);
        return this;

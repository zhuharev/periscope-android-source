...
//            AnalyticsProvider, MigrationDatabaseHelper, LocalyticsDao, DatapointHelper
...
_L18:
        ...
        s1 = ((String) (obj));
        list = ((List) (obj1));
        contentvalues1.put("upload_format", Integer.valueOf(rmat.V2.getValue()));
        if (l4 <= l1)
        {
...
_L17:
        ...
        s1 = s3;
        list = ((List) (obj1));
        contentvalues.put("upload_format", Integer.valueOf(rmat.V2.getValue()));
        l5 = l7;
        l2 = l4;
        s2 = s;
        l3 = l1;
...
_L8:
        ...
        obj2 = obj;
        contentvalues.put("queued_close_session_blob_upload_format", Integer.valueOf(rmat.V2.getValue()));
        if (s3 == null)
        {
        ...
        obj2 = obj;
        ((ContentValues) (obj1)).put("upload_format", Integer.valueOf(rmat.V2.getValue()));
        obj2 = obj;
...
_L19:
    ...
    rmat(String s, int i, LocalyticsDao localyticsdao)
    {

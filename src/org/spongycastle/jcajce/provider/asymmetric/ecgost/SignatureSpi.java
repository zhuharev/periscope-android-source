    ...
    implements PKCSObjectIdentifiers, X509ObjectIdentifiers
{
    ...
    private ECGOST3410Signer aDx;

    public SignatureSpi()
    {
        aDj = new GOST3411Digest();
        aDx = new ECGOST3410Signer();
    }
    ...
    protected void engineInitSign(PrivateKey privatekey)
    {
        ...
        if (appRandom != null)
        {
            aDx._mth02CA(true, new ParametersWithRandom(privatekey, appRandom));
            return;
        } else
        {
            aDx._mth02CA(true, privatekey);
            return;
        }
    }
    ...
    protected boolean engineVerify(byte abyte0[])
    {
        ...
        return aDx._mth02CA(abyte1, abyte0[0], abyte0[1]);
    }
}

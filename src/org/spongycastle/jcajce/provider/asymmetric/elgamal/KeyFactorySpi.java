...
public class KeyFactorySpi extends BaseKeyFactorySpi
{
    ...
    public final PrivateKey _mth02CA(PrivateKeyInfo privatekeyinfo)
    {
        ...
        if (asn1objectidentifier.equals(PKCSObjectIdentifiers.abl))
        {
            return new BCElGamalPrivateKey(privatekeyinfo);
        }
        if (asn1objectidentifier.equals(X9ObjectIdentifiers.ams))
        {
            return new BCElGamalPrivateKey(privatekeyinfo);
        }
        if (asn1objectidentifier.equals(OIWObjectIdentifiers.aay))
        {
            return new BCElGamalPrivateKey(privatekeyinfo);
        } else
        {

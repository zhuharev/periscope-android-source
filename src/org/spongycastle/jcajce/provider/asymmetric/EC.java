...
public class EC
{
    public static class Mappings extends AsymmetricAlgorithmProvider
    {
        ...
        public final void _mth02CA(ConfigurableProvider configurableprovider)
        {
            ...
            _mth02CA(configurableprovider, X9ObjectIdentifiers.alH, "EC", ((org.spongycastle.jcajce.provider.util.AsymmetricKeyInfoConverter) (new org.spongycastle.jcajce.provider.asymmetric.ec.KeyFactorySpi.EC())));
            _mth02CA(configurableprovider, X9ObjectIdentifiers.amp, "EC", ((org.spongycastle.jcajce.provider.util.AsymmetricKeyInfoConverter) (new org.spongycastle.jcajce.provider.asymmetric.ec.KeyFactorySpi.EC())));
            _mth02CA(configurableprovider, X9ObjectIdentifiers.amq, "ECMQV", ((org.spongycastle.jcajce.provider.util.AsymmetricKeyInfoConverter) (new org.spongycastle.jcajce.provider.asymmetric.ec.KeyFactorySpi.ECMQV())));

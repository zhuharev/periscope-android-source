...
//            X509SignatureUtil, ExtCRLException, X509CRLEntryObject
...
public class X509CRLObject extends X509CRL
{
    ...
    private static boolean _mth02CA(X509CRLObject x509crlobject)
    {
        boolean flag;
        try
        {
            x509crlobject = x509crlobject.getExtensionValue(Extension.aiK.identifier);
        }
        // Misplaced declaration of an exception variable
        catch (X509CRLObject x509crlobject)
        {
            throw new ExtCRLException("Exception reading IssuingDistributionPoint", x509crlobject);
        }
        if (x509crlobject == null)
        {
            break MISSING_BLOCK_LABEL_35;
        }
        flag = IssuingDistributionPoint._mth06E6(ASN1OctetString.FB39(x509crlobject)._mth0501()).ajp;
        if (flag)
        {
            return true;
        }

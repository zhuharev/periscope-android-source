...
public class PKIXCRLUtil
{
    ...
    private static HashSet _mth02CA(X509CRLStoreSelector x509crlstoreselector, List list)
    {
        HashSet hashset;
        Iterator iterator;
        boolean flag;
...
_L2:
        ...
        if (obj instanceof X509Store)
        {
            ...
            try
            {
                hashset.addAll(((X509Store) (obj)).aQo._mth02CA(x509crlstoreselector));
            }
...
_L1:
    ...
    public final HashSet _mth02CA(X509CRLStoreSelector x509crlstoreselector, ExtendedPKIXParameters extendedpkixparameters, Date date)
    {
        HashSet hashset1 = new HashSet();
        try
        {
            hashset1.addAll(_mth02CA(x509crlstoreselector, Collections.unmodifiableList(extendedpkixparameters.aPM)));
            hashset1.addAll(_mth02CA(x509crlstoreselector, Collections.unmodifiableList(new ArrayList(extendedpkixparameters.aPJ))));
            hashset1.addAll(_mth02CA(x509crlstoreselector, extendedpkixparameters.getCertStores()));
        }
        // Misplaced declaration of an exception variable

    ...
    implements BlockCipher
{
    ...
    private long _mth02CA(int i, int j, long l)
    {
        int k = (int)(l >> 32);
        int i1 = (int)l;
        int j1 = FBE6(FBE6(FBE6(k ^ i ^ (i1 ^ j)) + (k ^ i)) + FBE6(k ^ i ^ (i1 ^ j)));
        return (long)(j1 + FBE6(FBE6(k ^ i ^ (i1 ^ j)) + (k ^ i))) << 32 | (long)j1 & 0xffffffffL;
    }

    private static long _mth02CD(byte abyte0[], int i)
    {
        long l = 0L;
        for (int j = 0; j <= 7; j++)
        {
    ...
    private static void _mth02CE(byte abyte0[], int i, long l)
    {
        for (int j = 0; j < 8; j++)
        {
            abyte0[j + i] = (byte)(int)(l >> (7 - j << 3));
        }

    }

    private static int FBE6(int i)
    {
        return asQ[i & 0xff] ^ asR[i >> 8 & 0xff] ^ asS[i >> 16 & 0xff] ^ asT[i >>> 24];
    }
    ...
    public final int _mth02CA(byte abyte0[], int i, byte abyte1[], int j)
    {
        ...
        long l = _mth02CD(abyte0, i);
        long l1 = _mth02CD(abyte0, i + 8);
        long l3;
        long l4;
        if (amy)
        {
            for (i = 0; i < 16;)
            {
                long l2 = l ^ _mth02CA(asV[i * 2], asV[i * 2 + 1], l1);
                l = l1;
                i++;
                l1 = l2;
            }
        ...
        } else
        {
            ...
            do
            {
                ...
                l3 = l ^ _mth02CA(asV[i * 2], asV[i * 2 + 1], l1);
                l = l1;
                i--;
                l1 = l3;
            } while (true);
        }
        _mth02CE(abyte1, j, l4);
        _mth02CE(abyte1, j + 8, l3);
        return 16;
    }
    ...
    public final void _mth02CA(boolean flag, CipherParameters cipherparameters)
    {
        ...
        int ai[] = new int[32];
        long l2 = _mth02CD(cipherparameters, 0);
        long l1 = _mth02CD(cipherparameters, 8);
        int i1 = (int)(l2 >> 32);
        int l = (int)l2;
        int k = (int)(l1 >> 32);
        int j = (int)l1;
        for (int i = 0; i < 16; i++)
        {
            ai[i * 2] = FBE6((i1 + k) - asU[i]);
            ai[i * 2 + 1] = FBE6((l - j) + asU[i]);
            if (i % 2 == 0)
            {
                long l3 = l2 >>> 8 | l2 << 56;
                l2 = l3;

    ...
    implements MacDerivationFunction
{
    ...
    public final void _mth02CA(DerivationParameters derivationparameters)
    {
        ...
        auk._mth02CA(new KeyParameter(((KDFFeedbackParameters) (derivationparameters)).axt));
        aup = Arrays._mth1D4C(((KDFFeedbackParameters) (derivationparameters)).aup);
        int i = ((KDFFeedbackParameters) (derivationparameters)).axu;
        auo = new byte[i / 8];
        if (((KDFFeedbackParameters) (derivationparameters)).auq)
        {
        ...
        iv = ((KDFFeedbackParameters) (derivationparameters)).iv;
        auq = ((KDFFeedbackParameters) (derivationparameters)).auq;
        aui = 0;
    }

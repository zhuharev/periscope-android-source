    ...
    implements EncodableDigest
{
    ...
    public SHA256Digest(SHA256Digest sha256digest)
    {
        super(sha256digest);
        anQ = new int[64];
        _mth02CA(sha256digest);
    }

    private void _mth02CA(SHA256Digest sha256digest)
    {
        System.arraycopy(((GeneralDigest) (sha256digest)).anh, 0, super.anh, 0, 4);
        super.ani = ((GeneralDigest) (sha256digest)).ani;
        super.VD = ((GeneralDigest) (sha256digest)).VD;
        anM = sha256digest.anM;
        anN = sha256digest.anN;
        anO = sha256digest.anO;
        anP = sha256digest.anP;
        anT = sha256digest.anT;
        anU = sha256digest.anU;
        anV = sha256digest.anV;
        anW = sha256digest.anW;
        System.arraycopy(sha256digest.anQ, 0, anQ, 0, sha256digest.anQ.length);
        anI = sha256digest.anI;
    }
    ...
    {
        _mth02CA((SHA256Digest)memoable);
    }

    ...
    implements Selector
{
    ...
    public static X509CertStoreSelector _mth02CA(X509CertSelector x509certselector)
    {
        ...
        {
            throw new IllegalArgumentException((new StringBuilder("error in passed in selector: ")).append(x509certselector).toString());
        }

...
public class FF6D extends MultiAutoCompleteTextView
    implements FBE6
{
    ...
    public FF6D(Context context)
    {
        this(context, null);
    }

    public FF6D(Context context, AttributeSet attributeset)
    {
        this(context, attributeset, _cls1541.autoCompleteTextViewStyle);
    }

    public FF6D(Context context, AttributeSet attributeset, int i)
    {

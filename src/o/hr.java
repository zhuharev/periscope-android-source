        ...
        implements hr
    {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel1, int j)
        {
            ...
            case 2: // '\002'
                ...
                _mth02CA(authaccountrequest, hq.if.FF70(parcel.readStrongBinder()));
            ...
            case 5: // '\005'
                ...
                } else
                {
                    ...
                    {
                        parcel = new _cls14D9.if.if(parcel);
                    }
                }
            ...
            case 8: // '\b'
                ...
                _mth02CA(i, account, hq.if.FF70(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;

            case 9: // '\t'
                parcel.enforceInterface("com.google.android.gms.signin.internal.ISignInService");
                _cls14B4 _lcls14b4 = _cls14B4.if._mth02CB(parcel.readStrongBinder());
                i = parcel.readInt();
                boolean flag1;
                if (parcel.readInt() != 0)
                {
            ...
            case 10: // '\n'
                ...
                _mth02CA(recordconsentrequest, hq.if.FF70(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;

            case 11: // '\013'
                parcel.enforceInterface("com.google.android.gms.signin.internal.ISignInService");
                _mth02CA(hq.if.FF70(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;
            }
...
_L3:
    ...
    public abstract void _mth02CA(int i, Account account, hq hq);

    public abstract void _mth02CA(AuthAccountRequest authaccountrequest, hq hq);

    public abstract void _mth02CA(ResolveAccountRequest resolveaccountrequest, _cls14D9 _pcls14d9);

    public abstract void _mth02CA(CheckServerAuthResult checkserverauthresult);

    public abstract void _mth02CA(RecordConsentRequest recordconsentrequest, hq hq);

    public abstract void _mth02CA(hq hq);

    public abstract void _mth02CA(_cls14B4 _pcls14b4, int i, boolean flag);

    public abstract void _mth150B(int i);

    public abstract void _mth1D57(boolean flag);
}

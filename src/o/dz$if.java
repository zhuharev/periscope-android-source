...
label0:
    ...
    public boolean onTransact(int i, Parcel parcel, Parcel parcel1, int j)
    {
        ...
        case 1: // '\001'
            ...
            _mth02CA(arraylist, pendingintent, _mth02BD(parcel.readStrongBinder()), parcel.readString());
        ...
        case 57: // '9'
            ...
            _mth02CA(geofencingrequest, pendingintent2, _mth02BD(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;
        ...
        case 2: // '\002'
            ...
            _mth02CA(pendingintent1, _mth02BD(parcel.readStrongBinder()), parcel.readString());
            parcel1.writeNoException();
            return true;

        case 3: // '\003'
            parcel.enforceInterface("com.google.android.gms.location.internal.IGoogleLocationManagerService");
            _mth02CA(parcel.createStringArray(), _mth02BD(parcel.readStrongBinder()), parcel.readString());
            parcel1.writeNoException();
            return true;

        case 4: // '\004'
            parcel.enforceInterface("com.google.android.gms.location.internal.IGoogleLocationManagerService");
            _mth02CA(_mth02BD(parcel.readStrongBinder()), parcel.readString());
            parcel1.writeNoException();
            return true;
        ...
        case 8: // '\b'
            ...
            _mth02CA(((LocationRequest) (obj1)), _mth02BE(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;
        ...
        case 20: // '\024'
            ...
            _mth02CA(((LocationRequest) (obj2)), _mth02BE(parcel.readStrongBinder()), parcel.readString());
            parcel1.writeNoException();
            return true;
        ...
        case 52: // '4'
            ...
            _mth02CA(((LocationRequestInternal) (obj4)), _mth02BE(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;
        ...
        case 10: // '\n'
            parcel.enforceInterface("com.google.android.gms.location.internal.IGoogleLocationManagerService");
            _mth02CA(_mth02BE(parcel.readStrongBinder()));
            parcel1.writeNoException();
            return true;
        ...
        case 63: // '?'
            ...
            {
                android.os.IInterface iinterface = ((IBinder) (obj6)).queryLocalInterface("com.google.android.gms.location.internal.ISettingsCallbacks");
                if (iinterface != null && (iinterface instanceof ea))
                {
                    obj6 = (ea)iinterface;
                } else
                {
                    obj6 = new if(((IBinder) (obj6)));
                }
            }

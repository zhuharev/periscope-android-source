...
//            FBE6, _cls0715, FB33, _cls03C4

public class _cls05E5 extends TextView
    implements FBE6
{
    ...
    public _cls05E5(Context context)
    {
        this(context, null);
    }

    public _cls05E5(Context context, AttributeSet attributeset)
    {
        this(context, attributeset, 0x1010084);
    }

    public _cls05E5(Context context, AttributeSet attributeset, int i)
    {

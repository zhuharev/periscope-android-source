    ...
    extends IInterface
{
        ...
        implements gb
    {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel1, int j)
        {
            ...
            case 1: // '\001'
                ...
                if (parcel.readInt() != 0)
                {
                    hd hd1 = StreetViewPanoramaCamera.CREATOR;
                    parcel = hd._mth02D1(parcel);
                } else
                {
                    parcel = null;
                }
        ...
        implements gb
    {
        ...
        public final void _mth02CA(StreetViewPanoramaCamera streetviewpanoramacamera)
        {
            Parcel parcel;
            Parcel parcel1;
    ...
    public abstract void _mth02CA(StreetViewPanoramaCamera streetviewpanoramacamera);
}

    ...
    extends IInterface
{
        ...
        implements fb
    {
        ...
        public final bg _mth02C8(float f)
        {
            ...
            bg = o.bg.if._mth141D(parcel1.readStrongBinder());
            parcel1.recycle();
            parcel.recycle();
            return bg;
            Exception exception;
    ...
    public abstract bg _mth02C8(float f);

    public abstract bg _mth02C9(float f);

    public abstract bg _mth02CA(float f, int i, int j);

    public abstract bg _mth02CA(LatLng latlng, float f);

    public abstract bg _mth02CA(LatLngBounds latlngbounds, int i);

    public abstract bg _mth02CA(LatLngBounds latlngbounds, int i, int j, int k);

    public abstract bg _mth02CB(CameraPosition cameraposition);

    public abstract bg _mth02CF(LatLng latlng);

    public abstract bg _mth0696();

    public abstract bg _mth0697();

    public abstract bg _mth141D(float f, float f1);
}

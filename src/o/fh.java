        ...
        implements fh
    {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel1, int j)
        {
            ...
            case 15: // '\017'
                ...
                {
                    IInterface iinterface = parcel.queryLocalInterface("com.google.android.gms.maps.internal.IOnStreetViewPanoramaChangeListener");
                    if (iinterface != null && (iinterface instanceof gc))
                    {
                        parcel = (gc)iinterface;
                    } else
                    {
                        parcel = new gc.if.if(parcel);
                    }
                }
                _mth02CA(parcel);
                parcel1.writeNoException();
            ...
            case 16: // '\020'
                ...
                {
                    IInterface iinterface1 = parcel.queryLocalInterface("com.google.android.gms.maps.internal.IOnStreetViewPanoramaCameraChangeListener");
                    if (iinterface1 != null && (iinterface1 instanceof gb))
                    {
                        parcel = (gb)iinterface1;
                    } else
                    {
                        parcel = new gb.if.if(parcel);
                    }
                }
                _mth02CA(parcel);
                parcel1.writeNoException();
            ...
            case 17: // '\021'
                ...
                {
                    IInterface iinterface2 = parcel.queryLocalInterface("com.google.android.gms.maps.internal.IOnStreetViewPanoramaClickListener");
                    if (iinterface2 != null && (iinterface2 instanceof gd))
                    {
                        parcel = (gd)iinterface2;
                    } else
                    {
                        parcel = new gd.if.if(parcel);
                    }
                }
                _mth02CA(parcel);
                parcel1.writeNoException();
            ...
            case 18: // '\022'
                parcel.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                parcel = _mth141D(bg.if._mth141D(parcel.readStrongBinder()));
                parcel1.writeNoException();
                if (parcel != null)
                {
                    parcel1.writeInt(1);
            ...
            case 20: // '\024'
                ...
                {
                    IInterface iinterface3 = parcel.queryLocalInterface("com.google.android.gms.maps.internal.IOnStreetViewPanoramaLongClickListener");
                    if (iinterface3 != null && (iinterface3 instanceof ge))
                    {
                        parcel = (ge)iinterface3;
                    } else
                    {
                        parcel = new ge.if.if(parcel);
                    }
                }
                _mth02CA(parcel);
                parcel1.writeNoException();
...
label0:
    ...
    public abstract bg _mth02CA(StreetViewPanoramaOrientation streetviewpanoramaorientation);

    public abstract void _mth02CA(LatLng latlng, int i);

    public abstract void _mth02CA(StreetViewPanoramaCamera streetviewpanoramacamera, long l);

    public abstract void _mth02CA(gb gb);

    public abstract void _mth02CA(gc gc);

    public abstract void _mth02CA(gd gd);

    public abstract void _mth02CA(ge ge);

    public abstract StreetViewPanoramaOrientation _mth141D(bg bg);

    public abstract void _mth144A(String s);

    public abstract void _mth144A(boolean flag);

    public abstract void _mth1540(boolean flag);

    public abstract boolean _mth1D27();

    public abstract boolean _mth1D2E();

    public abstract boolean _mth1D33();

    public abstract boolean _mth1D3C();

    public abstract StreetViewPanoramaCamera _mth1D4D();

    public abstract StreetViewPanoramaLocation _mth1D50();

    public abstract void _mth1D55(boolean flag);

    public abstract void _mth1D63(boolean flag);
}

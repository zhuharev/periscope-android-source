        ...
        implements fg
    {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel1, int j)
        {
            ...
            case 1: // '\001'
                ...
                parcel = _mth02CF(bg.if._mth141D(parcel.readStrongBinder()));
...
label0:
    ...
    public abstract LatLng _mth02CF(bg bg);

    public abstract VisibleRegion _mth0689();

    public abstract bg _mth141D(LatLng latlng);
}

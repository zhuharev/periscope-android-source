...
public class _cls1551
{
    ...
    public _cls1551()
    {
        FB40 = _cls1505._fld1506;
        FB48 = _cls1505._fld1D16;
        _fld1D61 = 0;
    }

    public _cls1551(int i)
    {
        _mth02C8(10);
        _fld1D61 = 0;
    }

    static void _mth02CA(int ai[], Object aobj[], int i)
    {
...
_L1:
    ...
    final int indexOf(Object obj, int i)
    {
        ...
        int i1 = _cls1505._mth02CA(FB40, k, i);
        if (i1 < 0)
        {
            return i1;
        }
    ...
    final int _mth1D55()
    {
        ...
        int l = _cls1505._mth02CA(FB40, j, 0);
        if (l < 0)
        {
            return l;
        }

    ...
    extends IInterface
{
    ...
    public abstract bg _mth02BE(Bitmap bitmap);

    public abstract bg _mth02D1(float f);

    public abstract bg _mth1505(int i);

    public abstract bg _mth1540(String s);

    public abstract bg _mth1D55(String s);

    public abstract bg _mth1D63(String s);

    public abstract bg FF43();
}

...
public class _cls026D extends RadioButton
    implements _cls0140
{
    ...
    public _cls026D(Context context)
    {
        this(context, null);
    }

    public _cls026D(Context context, AttributeSet attributeset)
    {
        this(context, attributeset, _cls1541.radioButtonStyle);
    }

    public _cls026D(Context context, AttributeSet attributeset, int i)
    {

        ...
        implements fn
    {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel1, int j)
        {
            ...
            case 1: // '\001'
                ...
                parcel = _mth02CB(gq.if._mth1D62(parcel.readStrongBinder()));
            ...
            case 2: // '\002'
                parcel.enforceInterface("com.google.android.gms.maps.internal.IInfoWindowAdapter");
                parcel = _mth02CE(gq.if._mth1D62(parcel.readStrongBinder()));
                parcel1.writeNoException();
                if (parcel != null)
                {
                    parcel = parcel.asBinder();
...
_L3:
    ...
    public abstract bg _mth02CB(gq gq);

    public abstract bg _mth02CE(gq gq);
}

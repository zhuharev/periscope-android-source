...
public class FEAA extends ImageButton
    implements FBE6
{
    ...
    public FEAA(Context context)
    {
        this(context, null);
    }

    public FEAA(Context context, AttributeSet attributeset)
    {
        this(context, attributeset, _cls1541.imageButtonStyle);
    }

    public FEAA(Context context, AttributeSet attributeset, int i)
    {

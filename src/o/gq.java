    ...
    extends IInterface
{
        ...
        implements gq
    {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel1, int j)
        {
            ...
            case 18: // '\022'
                parcel.enforceInterface("com.google.android.gms.maps.model.internal.IMarkerDelegate");
                _mth02C8(bg.if._mth141D(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;
...
label0:
    ...
    public abstract String _mth0159();

    public abstract boolean _mth01F0();

    public abstract void _mth026B();

    public abstract void _mth0287();

    public abstract boolean _mth028B();

    public abstract void _mth02BB(LatLng latlng);

    public abstract void _mth02BC(float f, float f1);

    public abstract void _mth02BD(float f, float f1);

    public abstract boolean _mth02BD(gq gq1);

    public abstract void _mth02C8(bg bg);

    public abstract boolean _mth03A5();

    public abstract void _mth1D40(boolean flag);
